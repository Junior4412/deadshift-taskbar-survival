...
test('atributos equipados são somados sem mutação',()=>{const a={stats:{attack:4,hp:10,rate:.1}},b={stats:{attack:6,crit:.2}};assert.deepEqual(Loot.total([a,b]),{attack:10,hp:10,rate:.1,crit:.2,scrap:0});assert.equal(a.stats.attack,4)});
